...
export const uploadAPI = {
  profileImage: (formData) => api.post('/uploads/profile', formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  }),
  galleryImage: (formData) => api.post('/uploads/gallery', formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  }),
  deleteGallery: (url) => api.delete('/uploads/gallery', { data: { url } }),
};
...
export const adminAPI = {
  ...
  updateDJ: (id, data) => api.patch(`/admin/djs/${id}`, data),
  updateDJStatus: (id, status) => api.patch(`/admin/djs/${id}`, { status }),
  deleteDJ: (id) => api.delete(`/admin/djs/${id}`),
  getBookings: () => api.get('/admin/bookings'),
  getStats: () => api.get('/admin/stats'),
};
